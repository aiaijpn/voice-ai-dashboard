...
function buildSystemPrompt() {
  return [
    ...
    "6. company_wiki 候補で十分に答えられる場合は、それを優先して judgement を wiki_answer にしてください。",
    "7. 未回答で、question_stock に追加すべき場合は stockAction を append にしてください。",
    "8. company_wiki に将来追加すべきと判断した場合は wikiDraft を生成してください。",
    `9. 該当テーマが弱い、または特定できない場合は topicLabel を "${DEFAULT_TOPIC_LABEL}" にしてください。`,
